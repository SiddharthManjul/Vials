...
if (process.argv.length < 3) {
  console.error("Please provide Monad address as a parameter.");
  process.exit(1);
}
...
if (!/^0x[a-fA-F0-9]{40}$/.test(targetContract)) {
  console.error("Invalid Monad address provided.");
  process.exit(1);
}
...
export const hyperSyncEndpoint = "https://monad-testnet.rpc.hypersync.xyz/"; // More networks can be found here: https://docs.envio.dev/docs/HyperSync/hypersync-supported-networks
